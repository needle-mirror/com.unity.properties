...
namespace Unity.Properties
{
        ...
        where TSet : ISet<TElement>
    {
        ...
        /// <inheritdoc cref="PropertyBag{TContainer}.GetProperties()"/>
        public override PropertyCollection<TSet> GetProperties()
        {
            return PropertyCollection<TSet>.Empty;
        }

        /// <inheritdoc cref="PropertyBag{TContainer}.GetProperties(ref TContainer)"/>
        ...
        /// <inheritdoc cref="ICollectionPropertyBagAccept{TContainer}.Accept"/>
        ...
        /// <inheritdoc cref="ISetPropertyBagAccept{TContainer}.Accept"/>
        void ISetPropertyBagAccept<TSet>.Accept(ISetPropertyBagVisitor visitor, ref TSet container)
        {
            visitor.Visit(this, ref container);
        }

        /// <inheritdoc cref="ISetPropertyAccept{TSet}.Accept{TContainer}"/>
