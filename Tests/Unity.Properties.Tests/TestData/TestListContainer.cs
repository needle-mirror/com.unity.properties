...
namespace Unity.Properties.Tests
{
    ...
    {
        private readonly ListProperty<TestListContainer, int> m_Int32List = new ListProperty<TestListContainer, int>(
        ...
        private readonly ListProperty<TestListContainer, TestPrimitiveContainer> m_TestStructList = new ListProperty<TestListContainer, TestPrimitiveContainer>(
