...
{
    [TestFixture]
    partial class PropertyVisitorAdapterTests
    {
        ...
        class SingleAdapter : IVisitPropertyAdapter<Container, int>
        {
            TestVisitor Visitor;
            ...
            public void Visit(in VisitContext<Container, int> context, ref Container container, ref int value)
            {
        ...
        class MultiAdapter
            : IVisitPropertyAdapter<Container, int>
                , IVisitPropertyAdapter<int>
        {
            ...
            public void Visit<TContainer>(in VisitContext<TContainer, int> context, ref TContainer container,
                ref int value)
            {
        ...
        class WrappingAdapter : IVisitPropertyAdapter<Container, int>
        {
            TestVisitor Visitor;
        ...
        class ChainedAdapter : IVisitPropertyAdapter<Container, int>
        {
            TestVisitor Visitor;
            VisitStatus Status;
        ...
        class MultiContinueAdapter : IVisitPropertyAdapter<Container, int>
        {
            TestVisitor Visitor;
            int m_Repeat;
            bool m_WithAdapters;
        ...
        class MessageAdapter : IVisitPropertyAdapter<Container, int>
        {
            TestVisitor Visitor;
            string m_Message;
        ...
        class StopAdapter : IVisitPropertyAdapter<Container, int>
        {
            public StopAdapter()
            {
            }
        ...
        class ExcludeAdapter 
            : IExcludePropertyAdapter<int>
                , IExcludePropertyAdapter<float>
                , IVisitPropertyAdapter<int>
                , IVisitPropertyAdapter<float>
        {
            ...
            public bool IsExcluded<TContainer>(in ExcludeContext<TContainer, int> context, ref TContainer container, ref int value)
            {
                return true;
            }

            public bool IsExcluded<TContainer>(in ExcludeContext<TContainer, float> context, ref TContainer container, ref float value)
            {
                return false;
            }
        ...
        class ContravariantAdapter
            : IVisitContravariantPropertyAdapter<ContainerWithInterface, InterfaceA>
                , IVisitContravariantPropertyAdapter<ContainerWithInterface, InterfaceB>
                , IVisitContravariantPropertyAdapter<ContainerWithInterface, IInterface>
        {
            TestVisitor Visitor;
            ...
            public void Visit(in VisitContext<ContainerWithInterface> context, ref ContainerWithInterface container,
                InterfaceA value)
            {
        ...
        class MixedAdapter
            : IVisitPropertyAdapter<MixedContainer, IInterface>
        {
            TestVisitor Visitor;
            ...
            public void Visit(in VisitContext<MixedContainer, IInterface> context, ref MixedContainer container, ref IInterface value)
            {
                Visitor.Builder.Append("A");
                context.ContinueVisitation(ref container, ref value);
            }
        ...
        class MixedContravariantAdapter
            : IVisitContravariantPropertyAdapter<MixedContainer, IInterface>
        {
            TestVisitor Visitor;
            ...
            public void Visit(in VisitContext<MixedContainer> context, ref MixedContainer container, IInterface value)
            {
                Visitor.Builder.Append("A");
                context.ContinueVisitation(ref container);
            }
