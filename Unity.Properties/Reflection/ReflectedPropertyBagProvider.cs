...
namespace Unity.Properties.Reflection
{
    public class ReflectedPropertyBagProvider
    {
        ...
        private readonly MethodInfo m_CreatePropertyFromFieldInfoMethod;
        private readonly MethodInfo m_CreatePropertyFromPropertyInfoMethod;
        ...
        private void CreatePropertyFromFieldInfo<TContainer, TValue>(FieldInfo field, ReflectedPropertyBag<TContainer> propertyBag)
        {
        ...
        private void CreatePropertyFromPropertyInfo<TContainer, TValue>(PropertyInfo property, ReflectedPropertyBag<TContainer> propertyBag)
        {
            for (var index = m_Generators.Count - 1; index >= 0; index--)
            {
                var generator = m_Generators[index];
